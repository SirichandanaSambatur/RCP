...
void CodeAnalysisExecutive::performAnalysis() {
	std::cout << "\n-------------------------------------------------------------------------------\n";
	...
	std::cout << "\n Requirement 2- Used heap based memory management to store the type table and dependancy table details";
	std::cout << "\n-------------------------------------------------------------------------------\n";
	Display d;
	d.typeAnalysis();
	d.depAnalysis();
...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    Rslt::write("\n     " + exec.systemTime());
    Rslt::flush();
	std::cout << "\n------------------ Requirement 8- Command line Arguments taken by the program are---------------";
