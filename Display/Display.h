...
====================
ver 1.1: 04 Apr 2017
- adding the functionality to publish the pages
...
void Display::createMap() {
	...
	void Display::publishFiles() {
		std::cout << "\nRequirement 9- Important packages of project 3 are present in 'Project3-Packages' folder and now running the publisher on these packages\n\n";
		std::cout << "\n Once the publisher runs and create html files, they will be found in the folder HtmlFiles\n";
		std::cout << "\nRequirement 3- Invoking the Publisher to publish the files in the package------------\n\n";
